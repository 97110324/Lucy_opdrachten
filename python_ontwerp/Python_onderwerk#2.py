...
print("Kolommen in branches:")
print(branches.columns)
print("\nKolommen in bedrijven:")
print(bedrijven.columns)

# Renamen van kolommen indien nodig
branches.rename(columns={"IDBRANCH": "idbranch"}, inplace=True)
bedrijven.rename(columns={"IDBRANCH ": "idbranch"}, inplace=True)
